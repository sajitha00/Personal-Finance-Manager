...
class _MyDebtsState extends State<MyDebts> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      firstDate:
          DateTime.now(), // Ensures users can only select today or future dates
      lastDate: DateTime(2100), // You can set this to a far future date
    );
                      ...
                      PrimaryContainer(
                        componentWidgets: Column(
                          children: [
                            ...
                            OutlinedButton(
                              onPressed: () =>
                                  _selectDate(context), // Updated line
